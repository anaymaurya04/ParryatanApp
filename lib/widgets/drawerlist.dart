      ...
      child: Column(
        children: [
          menuItem(
            ...
            selected: currentPage == Drawersection.account ? true : false,
            onPressed: () {
          ...
          menuItem(
              ...
              selected: currentPage == Drawersection.settings ? true : false,
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) {
          ...
          menuItem(
              ...
              selected: currentPage == Drawersection.about ? true : false,
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) {
                  return const About();
                }));
...
enum Drawersection { account, home, settings, about }
